 ...
 * 有符号整数小于等于比较语句
 */
public class IntegerCompareSleInst extends IntegerCompareInst{
     ...
     * @param operand2 操作数2
     */
    public IntegerCompareSleInst(IntegerType operandType, Value operand1, Value operand2) {
     ...
     * @param operandType 待比较数据的类型，必须是IntegerType
     */
    public IntegerCompareSleInst(IntegerType operandType) {
        super(operandType);
    }
