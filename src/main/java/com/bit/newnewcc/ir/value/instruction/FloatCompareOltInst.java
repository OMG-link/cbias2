 ...
 */
public class FloatCompareOltInst extends FloatCompareInst{
     ...
     * @param operand2 操作数2
     */
    public FloatCompareOltInst(FloatType operandType, Value operand1, Value operand2) {
     ...
     * @param operandType 待比较数据的类型，必须是FloatType
     */
    public FloatCompareOltInst(FloatType operandType) {
        super(operandType);
    }
