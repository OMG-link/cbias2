 ...
 */
public class FloatCompareOneInst extends FloatCompareInst{
     ...
     * @param operand2 操作数2
     */
    public FloatCompareOneInst(FloatType operandType, Value operand1, Value operand2) {
     ...
     * @param operandType 待比较数据的类型，必须是FloatType
     */
    public FloatCompareOneInst(FloatType operandType) {
        super(operandType);
    }
