 ...
 */
public class FloatCompareOleInst extends FloatCompareInst{
     ...
     * @param operand2 操作数2
     */
    public FloatCompareOleInst(FloatType operandType, Value operand1, Value operand2) {
     ...
     * @param operandType 待比较数据的类型，必须是FloatType
     */
    public FloatCompareOleInst(FloatType operandType) {
        super(operandType);
    }
