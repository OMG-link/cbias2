...
public class BranchToMinMaxPass {
    ...
    private static boolean runOnBasicBlock(BasicBlock branchBlock) {
        ...
        if (!(trueBlock.getTerminateInstruction() instanceof JumpInst trueJump)) return false;
        if (!(falseBlock.getTerminateInstruction() instanceof JumpInst falseJump)) return false;
